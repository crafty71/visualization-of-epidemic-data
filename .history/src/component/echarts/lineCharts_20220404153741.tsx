...
const lineCharts: any = memo((props: any) => {
  ...
  const option = {
    dataset: {
      source: [
        { product: "Matcha Latte", count: 823, score: 95.8, value: 102 },
        { product: "Milk Tea", count: 235, score: 81.4, value: 87 },
        { product: "Cheese Cocoa", count: 1042, score: 91.2, value: 79 },
        { product: "Walnut Brownie", count: 988, score: 76.9, value: 187 },
      ],
    },
    title: {
