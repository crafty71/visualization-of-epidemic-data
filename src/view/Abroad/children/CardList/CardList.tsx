  ...
  return (
    <CardListWrapper>
      <Row gutter={8} style={{ marginBottom: "8px" }}>
        <Col span={6}>
          <Card title="累计确诊" className="confirm">
            <p className="cardContent confirmContent">{WomWorldData.confirm}</p>
          </Card>
        </Col>
        <Col span={6}>
          <Card title="新增确诊" className="confirmAdd">
            <p className="cardContent">{WomWorldData.confirmAdd}</p>
          </Card>
        </Col>
        <Col span={6}>
          <Card title="累计治愈">
            <p className="cardContent confirmAddContent">{WomWorldData.heal}</p>
          </Card>
        </Col>
        <Col span={6}>
          <Card title="新增治愈">
